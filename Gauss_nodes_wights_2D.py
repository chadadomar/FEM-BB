...
# -*- coding: utf-8 -*-
"""
Created on Fri Jan 19 19:30:22 2024
...
def NodesWeights(p):
    ...
    # Output:
        # X: xy-coordinate array of quadrature points
        # W: weights array
    if p==0:
        raise Exception("order of quadrature not valid")
    if p==1:
        table= [3.33333333333333e-01,3.33333333333333e-01,5.00000000000000e-01]
        
    elif p==2:
        table=[1.66666666666666e-01,
    ...
    ######################################################################
        ...
        table = [   4.8896391036217808e-001,
                    ...
                    2.5051144192504996e-003]
    ###########################################################################################
    elif p==15 or p==16 or p==17:
        table=      [3.3333333333333332e-001,
    ...
    lesy=table[n:2*n]
    W=table[2*n:3*n]
    X=[[lesx[i],lesy[i]] for i in range(n)]
    return X,W,n
